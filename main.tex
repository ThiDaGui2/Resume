...
\title{Elève ingénieur de 4\textsuperscript{ème} année à l'\emph{EPITA} pour un stage de 4 mois en Engine Programmer \newline\footnotesize{à partir de septembre 2022}}
...
\begin{multicols}{2}
\setlength{\maincolumnwidth}{\linewidth-\leftskip-\rightskip-\hintscolumnwidth}
\vspace{\secpostVsp}
